...
# """
# FastAPI application for the Email Rl Environment.

# This module creates an HTTP server that exposes the EmailRlEnvironment
...
#     from .Email_RL_environment import EmailRlEnvironment
# except ModuleNotFoundError:
#     from models import EmailRlAction, EmailRlObservation
#     from server.Email_RL_environment import EmailRlEnvironment
...
#     multiple workers:
#         uvicorn Email_RL.server.app:app --workers 4
#     """
#     import uvicorn
...
app = create_app(
    ...
    env_name="Email_RL",
    # Each WebSocket session gets its own EmailTriageEnvironment instance

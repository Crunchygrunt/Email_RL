...
#             correct_fields.append("priority OK")
#         else:
#             correct_fields.append("priority WRONG")
#         if obs.last_category_correct:
#             correct_fields.append("category OK")
#         else:
#             correct_fields.append("category WRONG")
#         if obs.last_route_correct:
#             correct_fields.append("route OK")
#         else:
#             correct_fields.append("route WRONG")
...
#             feedback_parts = []
#             if obs.last_priority_correct is not None:
#                 feedback_parts.append(f"pri={'OK' if obs.last_priority_correct else 'WRONG'}")
#             if obs.last_category_correct is not None:
#                 feedback_parts.append(f"cat={'OK' if obs.last_category_correct else 'WRONG'}")
#             if obs.last_route_correct is not None:
#                 feedback_parts.append(f"rte={'OK' if obs.last_route_correct else 'WRONG'}")
...
def _call_llm(
    ...
    if obs.last_priority_correct is not None:
        parts = []
        parts.append(f"priority={'OK' if obs.last_priority_correct else 'WRONG'}")
        parts.append(f"category={'OK' if obs.last_category_correct else 'WRONG'}")
        parts.append(f"route={'OK'    if obs.last_route_correct    else 'WRONG'}")
...
async def main() -> None:
    ...
    Total runtime: 3 tasks ? 10 steps ? ~2s per LLM call ? 60s
